    ...
    <aside className="hidden h-screen w-72 border-r border-gray-200 bg-white lg:flex lg:flex-col">
      ...
      <div className="border-b border-gray-200 px-6 py-6">
        <Link href="/">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-xl font-bold text-gray-900">GearUp</h2>

              <p className="text-sm text-gray-500 capitalize">Admin Panel</p>
            </div>
          </div>
        </Link>
      </div>
      ...
      <div className="flex-1 overflow-y-auto px-4 py-6">
        ...
        <nav className="space-y-2">
          {menus.map((menu) => (
            <SidebarItem key={menu.href} {...menu} />
          ))}
        </nav>
      </div>
      ...
      <div className="border-t border-gray-200 p-5">
        <div className="mb-5 flex items-center gap-3 rounded-2xl bg-slate-50 p-3">
          ...
          <div>
            ...
            <p className="text-sm text-gray-500">admin@gearup.com</p>
          </div>
        </div>
